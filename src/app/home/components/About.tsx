...
const About = () => {
  return (
    <div className="bg-ourblack -mt-2">
      <div className=" min-h-[40rem] text-white items-center gap-6 flex flex-col py-20 justify center mycontainer">
        <h2 className="text-5xl  lg:text-6xl  font-bold  w-full text-center">
          Tentang Kami
        </h2>
        <p className="text-xs lg:text-lg text-center lg:w-[80%]">
