      ...
      <div className="mycontainer h-fit pb-32 lg:flex justify-between gap-x-10 text-white">
        ...
        <div className="lg:flex mt-10 lg:mt-0  gap-4 w-full justify-between text-black">
          <div className="lg:w-3/4">
            <div className="layanan1 bg-gray-200 rounded-3xl h-32 text-sm 2xl:text-lg lg:h-44 p-4 lg:p-2 lg:text-sm xl:p-8">
            ...
            <div className="flex gap-4 mt-4">
              <div className="h-52 layanan2 bg-gray-200 w-full text-sm   2xl:text-lg rounded-3xl p-4 lg:p-2 lg:text-sm xl:p-8">
                Mentor berpengalaman di bidangnya yang siap membimbingmu dengan
                pendekatan interaktif dan personal.
              </div>
              <div className="h-52 layanan3 bg-gray-200 w-full rounded-3xl 2xl:text-lg text-sm p-4 lg:p-2 lg:text-sm xl:p-8">
                Ruang diskusi yang seru untuk bertukar ide, pengalaman, dan
                perspektif!
              </div>
            </div>
          </div>
          <div className="bg-gray-200 layanan4 mt-4 h-32 lg:h-full lg:mt-0 2xl:text-lg text-sm lg:w-1/4 rounded-3xl lg:p-2 lg:text-sm xl:p-8 p-4">
